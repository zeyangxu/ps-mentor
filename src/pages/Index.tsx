          ...
          <Card className="p-6 animate-fade-up group hover:shadow-lg transition-all duration-300">
            <CardContent className="p-0">
              ...
              <p className="text-muted-foreground leading-relaxed">
                个人陈述（Personal Statement, 简称PS）是欧美大学申请中至关重要的一环。一篇出色的PS能<span className="text-primary drop-shadow-[0_0_0.5px_#7c3aed]">弥补学术成绩及相关经验的不足</span>，帮助申请者在众多竞争者中脱颖而出。而相反，一篇质量不佳的PS可能会<span className="text-primary drop-shadow-[0_0_0.5px_#7c3aed]">拉低整体申请水平</span>，甚至让招生官对申请者的能力和动机产生质疑。
              </p>
            </CardContent>
          </Card>
